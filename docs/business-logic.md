...
| **2** | Shadowsocks 2022 | **Нет** | Отключен в подписке |

**Важно**: Только VLESS Reality (type_vpn=1) входит в subscription систему. Outline и Shadowsocks — отдельно.
...
|---------|--------|-----------|--------|
| **Telegram Stars** | XTR | 1₽ = 0.5⭐ | ✅ Активен |
| **KassaSmart** | RUB | 1:1 | ✅ Активен |
| **CryptoBot** | Crypto | По курсу | ✅ Активен |
| **Lava** | RUB | 1:1 | ❌ Отключен |
| **Cryptomus** | Crypto | По курсу | ❌ Отключен |
