...
5. Откройте файл .env и заполните все поля 
    ...
    POSTGRES_USER= Имя пользователя для достпука к БД
    POSTGRES_PASSWORD= Пароль для доступа к БД
    PGADMIN_DEFAULT_EMAIL= Email для входя в панель управления БД
    PGADMIN_DEFAULT_PASSWORD= Пароль для входа в панель управления БД
